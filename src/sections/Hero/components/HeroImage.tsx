  ...
  return (
    <div className="relative box-border caret-transparent">
      <div className="absolute box-border caret-transparent bottom-[0%] inset-x-[0%]">
        ...
        <h1 className="text-white text-5xl font-semibold box-border caret-transparent leading-tight text-center uppercase translate-y-4 md:text-[120px] md:leading-[95px] md:text-start md:pl-[56px] md:translate-y-12">
          Khushi
        </h1>
        </div>
      </div>
