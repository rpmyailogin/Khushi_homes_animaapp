  ...
  return (
    <section className="bg-black box-border caret-transparent py-10 md:py-16">
      <div className="box-border caret-transparent max-w-full w-full mx-auto px-5 md:max-w-[1336px]">
        <div className="flex items-start gap-x-8 mb-8 md:mb-10">
          <div className="text-white text-sm items-center box-border caret-transparent gap-x-2 flex justify-start leading-[16.8px] uppercase">
