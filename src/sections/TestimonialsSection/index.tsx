...
export const TestimonialsSection = () => {
  return (
    <section className="bg-black box-border caret-transparent overflow-hidden mb-10 pt-8 pb-12 sm:mb-12 sm:pt-10 sm:pb-16 md:mb-[150px] md:pt-[60px] md:pb-[135px]">
