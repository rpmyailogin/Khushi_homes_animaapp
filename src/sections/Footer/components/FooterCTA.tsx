  ...
  return (
    <>
      <div className="items-start border-l-zinc-800 border-r-zinc-800 border-t-zinc-800 box-border caret-transparent flex flex-col justify-between gap-y-10 pb-10 border-b-white/20 border-b md:items-start md:flex-row md:gap-x-10 md:gap-y-[normal] md:pb-[50px]">
        <div className="items-start box-border caret-transparent flex flex-col justify-start max-w-none w-full md:max-w-[45%]">
          <h2 className="text-white text-[26px] box-border caret-transparent leading-[33.8px] mb-5 md:text-[40px] md:leading-[52px]">
        ...
        <div className="box-border caret-transparent w-full md:max-w-[45%]">
